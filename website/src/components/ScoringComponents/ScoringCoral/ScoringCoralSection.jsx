...
const ScoringCoralSection = ({
  ...
  return (
    <section className="flex w-full h-full bg-[#3B3B3B] border-8 border-[#1D1E1E] rounded-xl flex-col justify-center items-center">
      <h1 className="flex w-full h-full justify-center items-center text-white text-3xl font-bold pt-2">
        Coral
      </h1>
      <div
      ...
      <div className="flex w-full h-auto ~px-2/4 pb-4">
        <ScoringPickup
          pickData={pickData}
          pickPositionSelected={pickPositionSelected}
          setPickPositionSelected={setPickPositionSelected}
